...
export const metadata: Metadata = { title: "Dog Decision Guides | The Dog Bond", description: "Practical dog ownership decision guides for choosing, training, managing, and living responsibly with dogs in African households." };
