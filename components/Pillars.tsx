...
export function Pillars() {
  return (
    <section id="pillars" className="bg-earth-50 px-5 py-24 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {pillars.map((pillar) => (
            <article key={pillar.title} className="group rounded-[2rem] border border-earth-200 bg-white p-7 shadow-card transition hover:-translate-y-1 hover:shadow-soft">
