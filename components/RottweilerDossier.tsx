...
const modules = [
  { id: "household", n: "01", title: "Household fit", text: "A Rottweiler is not a security appliance. It needs stable routines, humane social learning, space to withdraw and adults able to manage a strong dog without intimidation." },
  { id: "children", n: "02", title: "Children and vulnerable people", text: "No breed label guarantees safety. Separate during food, sleep, rough play and excited arrivals. Teach children not to climb on, corner or disturb the dog; an attentive adult remains responsible." },
  { id: "public", n: "03", title: "Visitors and public space", text: "Plan before the gate opens: secure first, admit visitors second. Use sound fencing, identification, leash skills and controlled introductions. Do not encourage uncontrolled suspicion or aggression." },
  { id: "acquisition", n: "04", title: "Breeder due diligence", text: "Ask for verifiable parent identity, health-screening records, veterinary history, living-condition access and a written return policy. Photographs, size claims and payment receipts are not health evidence." },
  { id: "training", n: "05", title: "Humane training pathway", text: "Begin with name response, recall foundations, handling, settling, leash skills, leave-it and place work. Reward calm behaviour. Escalating fear or punishment can make behaviour less predictable; seek qualified help early." },
  { id: "records", n: "06", title: "Evidence and continuity", text: "Keep vaccination and veterinary records, identification details, acquisition documents, training notes, household rules and incident observations. Records turn memory into responsible follow-through." }
];
